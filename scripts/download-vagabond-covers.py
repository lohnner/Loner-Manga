...
OUTPUT = ROOT / "Mangás" / "Vagabond"
METADATA = Path(__file__).with_name("vagabond-volumes.json")
TARGET_SIZE = (500, 750)
...
def download_cover(volume):
    ...
    with Image.open(BytesIO(raw)) as source:
        ...
        image.save(OUTPUT / f"Vagabond #{number}.png", "PNG", optimize=True)
    return number
...
def main():
    ...
    print("Capas oficiais de Vagabond padronizadas em 500x750 px.")
