...
OUTPUT = ROOT / "Mangás" / "Fullmetal Alchemist"
OUTPUT.mkdir(parents=True, exist_ok=True)
volumes = json.loads((ROOT / "scripts" / "fullmetal-alchemist-volumes.json").read_text(encoding="utf-8"))


def download(volume):
    destination = OUTPUT / f"Fullmetal Alchemist #{volume['number']}.png"
    last_error = None
