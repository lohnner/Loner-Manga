...
OUTPUT = ROOT / "Mangás" / "One Punch-Man"
OUTPUT.mkdir(parents=True, exist_ok=True)
volumes = json.loads((ROOT / "scripts" / "one-punch-man-volumes.json").read_text(encoding="utf-8"))

def download(volume):
    destination = OUTPUT / f"One Punch-Man #{volume['number']}.png"
