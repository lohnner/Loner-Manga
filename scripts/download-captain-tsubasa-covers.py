...
OUTPUT = ROOT / "Mangás" / "Captain Tsubasa"
METADATA = Path(__file__).with_name("captain-tsubasa-volumes.json")
TARGET_SIZE = (500, 750)
...
def download_cover(volume):
    ...
    with Image.open(BytesIO(raw)) as source:
        ...
        image.save(OUTPUT / f"Captain Tsubasa #{number}.png", "PNG", optimize=True)
    return number
...
def main():
    ...
    print("Capas oficiais de Captain Tsubasa padronizadas em 500x750 px.")
