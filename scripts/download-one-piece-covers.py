...
OUTPUT = ROOT / "Mangás" / "One Piece"
METADATA = Path(__file__).with_name("one-piece-volumes.json")
TARGET_SIZE = (500, 750)
...
def download_cover(volume):
    ...
    with Image.open(BytesIO(raw)) as source:
        ...
        destination = OUTPUT / f"One Piece #{number}.png"
...
def main():
    ...
    print("Todas as capas oficiais de One Piece foram padronizadas em 500x750 px.")
